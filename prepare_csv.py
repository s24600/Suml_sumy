"""
This script downloads the gym members exercise dataset from Kaggle 
and prepares it for training a model.
"""
...
exercise_tracking_numeric['Time_Week'] = (
    exercise_tracking_numeric['Session_Duration (hours)'] * exercise_tracking_numeric['Workout_Frequency (days/week)']
)
exercise_tracking_numeric = (
    exercise_tracking_numeric.drop(columns=[
